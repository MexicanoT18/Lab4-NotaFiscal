 ...
 * @author Lucas
 */
public final class Servico implements Mercadoria{
    ...
    public Servico(double preco, String nome, List<Mercadoria> submercadorias, List<Imposto> impostos){
        _preco = preco;
        _nome = nome;
        _impostos = impostos;
    ...
    public boolean equals(Object object){
        if (!(object instanceof Servico)) return false;
        Servico outro = (Servico)object;
